<?php if (!defined('THINK_PATH')) exit();?><title>类别</title>
...
<div class="cate_top">
    <div style="font-size: 50px;color: #009688">类别</div>
    <!--<?php if(is_array($cate)): foreach($cate as $key=>$item): ?>-->
        <!--<div class="cate_name">-->
            <!--<a href="/Home/Index/index?cate_id=<?php echo ($item['id']); ?>"><?php echo ($item['cate_name']); ?></a>-->
        <!--</div>-->
    <!--<?php endforeach; endif; ?>-->
    <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="cate_name">
            <a href="/Home/Index/index?cate_id=<?php echo ($vo['id']); ?>"><?php echo ($vo['cate_name']); ?></a> <?php echo ($vo['count']); ?>
